...
! function() {
    ...
    const vm = [or("find")],
        ...
        Tm = (e, t, o) => {
            t.disableClass.each((t => {
                La(e.element, t)
            })), (Sm(e, t) ? km : Cm)(e), t.onDisabled(e)
        },
        Em = (e, t, o) => {
            t.disableClass.each((t => {
                Pa(e.element, t)
            })), (Sm(e, t) ? Om : _m)(e), t.onEnabled(e)
        },
                ...
                return {
                    ...
                    behaviours: hu(e.inlineBehaviours, [$d.config({
                        ...
                        channels: { ...Jd({
                            ...
                            ...Qd({ ...e.fireRepositionEventInstead.map((e => ({
                                    fireEventInstead: {
                                        event: e.event
                                    }
                                }))).getOr({}),
    ...
    const mb = "tox-menu-nav__js",
        ...
        zv = Dn([Sv("contextform"), Cr("initValue", x("")), mv, dr("commands", Vv), mr("launch", Jn("type", {
    ...
    const hy = (e, t) => {
        ...
        Ty = (e, t, o, n) => {
            ...
            return {
                ...
                itemBehaviours: kl([Kp("item-events", [Oy(e, o), Sy(e, r), ky(e, r)]), (s = () => !e.enabled || n.isDisabled(), Fm.config({
                    disabled: s,
    ...
    const mx = {},
        ...
        Cx = "#000000",
        _x = (e, t) => {
            const o = ((e, t) => t === yx ? Ox("color_cols_foreground")(e) : t === xx ? Ox("color_cols_background")(e) : Ox("color_cols")(e))(e, t);
            return o > 0 ? o : 5
        },
        Tx = Ox("custom_colors"),
            ...
            const o = Ve(e.selection.getStart()),
                n = "hilitecolor" === t ? Ir(o, (e => {
                    if (Ge(e)) {
                        ...
                        return Oe(sx(t).exists((e => 0 !== e.alpha)), t)
                    }
                    return A.none()
        ...
        Fx = (e, t, o, n) => {
            ...
            }), Dx(e, t).getOr(Cx)) : "remove" === o ? (n(""), e.execCommand("mceRemoveTextcolor", t)) : (n(o), e.execCommand("mceApplyTextcolor", t, o))
        },
        ...
        _w = (e, t, o, n, r, s, a) => {
            ...
            return we(H(e, (e => {
                switch (e.type) {
                    ...
                    default:
                        return (e => qn("Autocompleter.Item", Cv, e))(e).fold(qb, (e => A.some(((e, t, o, n, r, s, a, i = !0) => {
                            const l = Vy({
                                presets: n,
                                textContent: A.none(),
                        ...
                        (n = Ve(e.getBody()), pi(n, lb)).each((n => {
                            ...
                            Hh.showMenuAt(r, {
                                ...
                                return {
                                    ...
                                    menu: {
                                        markers: Cb(n),
                                        fakeFocus: o === Ow.ContentFocus
                                    }
                                }
                            })(Kb("autocompleter-value", !0, o, s, {
                                menuType: "normal"
                            }), s, Ow.ContentFocus, "normal"))
    ...
    const rO = hm({
            ...
            configFields: [yr("stepSize", 1), yr("onChange", b), yr("onChoose", b), yr("onInit", b), yr("onDragStart", b), yr("onDragEnd", b), yr("snapToGrid", !1), yr("rounded", !0), ur("snapStart"), nr("model", Jn("mode", {
                ...
                xy: [yr("minX", 0), yr("maxX", 100), yr("minY", 0), yr("maxY", 100), er("value", (e => Er({
                    x: e.mode.minX,
                    y: e.mode.minY
                }))), or("getInitialValue"), Ri("manager", nO)]
        ...
        mO = {
            ...
            sketch: e => {
                const t = (() => {
                        const e = [];
                        return {
                            field: (t, o) => (e.push(t), Ku(lO, dO(t), o)),
                            record: x(e)
                        }
                    })(),
                    o = e(t),
                ...
                c = pm({
                    factory: () => {
                        const r = {
                            ...
                            g = (e, t) => {
                                ...
                                (e => "hex" === e.type)(n) ? ((e, t) => {
                                    ...
                                    d(t, A.some(n)), c("red").bind((e => c("green").bind((t => c("blue").map((o => ex(e, t, o, 1))))))).each((t => {
                                        const o = ((e, t) => {
                                            const o = Xy(t);
                                            return mO.getField(e, "hex").each((t => {
                            ...
                            p = t => ({
                                label: e(fO + t + ".label"),
                                description: e(fO + t + ".description")
                            }),
                            h = p("red"),
                            f = p("green"),
                            b = p("blue"),
                            v = p("hex");
                        return fn(mO.sketch((o => ({
                            dom: {
                                tag: "form",
                                classes: [t("rgb-form")],
                                attributes: {
    ...
    const DO = la("alloy-fake-before-tabstop"),
        ...
        XO = (e, t, o) => {
            const n = Er(b),
                ...
                u = Uh(xw.sketch({ ...e.uid ? {
                    ...
                    dropdownBehaviours: kl([...e.dropdownBehaviours, vy((() => e.disabled || o.providers.isDisabled())), by(), SS.config({}), Xp.config({}), Kp("dropdown-events", [Sy(e, n), ky(e, n)]), Kp(d, [Ys(((e, t) => PO(e)))]), Kp("menubutton-update-display-text", [Us($O, ((e, t) => {
        ...
        JO = (e, t) => {
            const o = ((e, t) => {
                const o = j(e, ((e, o) => (e => s(e))(o) ? "" === o ? e : "|" === o ? e.length > 0 && !KO(e[e.length - 1]) ? e.concat([YO]) : e : ve(t, o.toLowerCase()) ? e.concat([t[o.toLowerCase()]]) : e : e.concat([o])), []);
        ...
        tC = (e, t, o, n) => H(o, (o => QO(o) ? {
            ...
            type: "nestedmenuitem",
            text: o.text,
            getSubmenuItems: () => tC(e, t, o.items, n)
        })),
        ...
        aC = x([sC("field1", "field2"), sC("field2", "field1"), Lu({
            factory: Ph,
            schema: [or("dom")],
            name: "lock",
            overrides: e => ({
        ...
        wC = (e, t, o) => {
            ...
            (r ? () => {
                ...
                fC(e, t)
            })(), Pa(n, t.shrinkingClass), La(n, t.growingClass), bC(e, t), Dt(e.element, gC(t), a), o.setExpanded(), t.onStartGrow(e)
        },
        SC = (e, t, o) => {
            const n = mC(e, t);
    ...
    var OC = Object.freeze({
        ...
        CC = Object.freeze({
            ...
            events: (e, t) => Hs([Ks(os(), ((o, n) => {
                n.event.raw.propertyName === e.dimension.property && (hC(o, e), t.isExpanded() && Ht(o.element, e.dimension.property), (t.isExpanded() ? e.onGrown : e.onShrunk)(o))
            }))])
        }),
        _C = [or("closedClass"), or("openClass"), or("shrinkingClass"), or("growingClass"), ur("getAnimationRoot"), Di("onShrunk"), Di("onStartShrink"), Di("onGrown"), Di("onStartGrow"), yr("expanded", !1), nr("dimension", Jn("property", {
    ...
    const TC = Cl({
        ...
        NC = ({
            ...
            components: e.map((e => "leaf" === e.type ? FC({
                leaf: e,
                onLeafAction: t,
                visible: o,
                treeId: n,
        ...
        VC = ({
            ...
            return {
                ...
                behaviours: kl([lh.config({ ...e.children.length > 0 ? {
                        aria: {
                            mode: "expanded"
                        }
                    } : {},
    ...
    const WC = Cl({
        ...
        KC = x([Pu({
            ...
            overrides: e => ({
                ...
                onExecute: (t, o) => e.lazyTypeaheadComp.get().map((e => (Is(e, qC(), {
                    item: o
                }), !0))),
                onHover: (t, o) => {
                    ...
                    c = [eh.config({}), mu.config({
                        ...
                        onEnter: t => {
                            const o = ew.getCoupled(t, "sandbox"),
                                n = $d.isOpen(o);
                            if (n && !e.previewing.get()) return i(o).bind((e => Wm.getHighlighted(e))).map((e => (Is(t, qC(), {
                                item: e
                            }), !0))); {
        ...
        y_ = {
            ...
            label: v_(((e, t) => ((e, t) => {
                return {
                    ...
                    behaviours: kl([yO(), Xp.config({}), (o = A.none(), kO(o, ea, ta)), Hp.config({
                        mode: "acyclic"
                    })])
                };
                var o
            ...
            checkbox: v_(((e, t, o) => ((e, t, o) => {
                const n = e => (e.element.dom.click(), A.some(!0)),
                    r = Xw.parts.field({
                        ...
                        behaviours: kl([yO(), Fm.config({
                            disabled: () => !e.enabled || t.isDisabled()
                        }), Jw.config({}), eh.config({}), CO(o, b_, f_), Hp.config({
                            mode: "special",
                            onEnter: n,
                            onSpace: n,
                            stopSpaceKeyup: !0
                    ...
                    d = Xw.parts.field({
                        factory: {
                            sketch: e => ({
                                ...
                                behaviours: kl([TO(o.getOr([])), yO(), Fm.config({}), lh.config({
                    ...
                    a = Xw.parts.field({
                        ...
                        factory: {
                            sketch: o => XO({
                                ...
                                presets: "normal",
                                classes: [],
                                dropdownBehaviours: [Jw.config({}), _O(r.map((e => e.value)), (e => Ct(e.element, eC)), ((t, o) => {
                                    oC(e.items, o).each((e => {
                                        kt(t.element, eC, e.value), Is(t, $O, {
                                            text: e.text
                                        })
                                    }))
                                }))]
            ...
            sizeinput: v_(((e, t) => ((e, t) => {
                ...
                return iC.sketch({
                    ...
                    coupledFieldBehaviours: kl([Fm.config({
                        disabled: () => !e.enabled || t.isDisabled(),
                        onDisabled: e => {
                            iC.getField1(e).bind(Xw.getField).each(Fm.disable), iC.getField2(e).bind(Xw.getField).each(Fm.disable), iC.getLock(e).each(Fm.disable)
                        },
                        onEnabled: e => {
                            iC.getField1(e).bind(Xw.getField).each(Fm.enable), iC.getField2(e).bind(Xw.getField).each(Fm.enable), iC.getLock(e).each(Fm.enable)
                        }
                        ...
                        o = ((e, t) => {
                            const o = lC(e).toOptional(),
                                n = lC(t).toOptional();
                            return Se(o, n, ((e, t) => cC(e, t.unit).map((e => t.value / e)).map((e => {
                                return o = e, n = t.unit, e => cC(e, n).map((e => ({
                                    value: e * o,
                                    unit: n
                                })));
                                var o, n
                        ...
                        fetch: n => {
                            const r = ((e, t, o) => {
                                    ...
                                    return o.getLinkInformation().fold((() => []), (t => {
                                        ...
                                        return "file" === e ? (r = [n, p_(a, d_(t)), p_(a, q([m_(t), u_(t), g_(t)]))], j(r, ((e, t) => 0 === e.length || 0 === t.length ? e.concat(t) : e.concat(a_, t)), [])) : n;
                                        var r
                                    }))
                                })(e.filetype, n, o),
                                s = ZO(r, ub.BUBBLE_TO_SANDBOX, t, {
                                    isHorizontalMenu: !1,
                                    search: A.none()
                                });
                            return aw(s)
            ...
            customeditor: v_((e => {
                ...
                return {
                    ...
                    behaviours: kl([Kp("custom-editor-events", [Ys((r => {
                        o.getOpt(r).each((o => {
                            ((e => ve(e, "init"))(e) ? e.init(o.element.dom) : AO.load(e.scriptId, e.scriptUrl).then((t => t(o.element.dom, e.settings)))).then((e => {
                                n.on((t => {
                                    e.setValue(t)
                                })), n.clear(), t.set(e)
                            }))
                        }))
                    }))]), _O(A.none(), (() => t.get().fold((() => n.get().getOr("")), (e => e.getValue()))), ((e, o) => {
            ...
            tree: v_(((e, t) => ((e, t) => {
                ...
                return {
                    ...
                    components: e.items.map((e => "leaf" === e.type ? FC({
                        leaf: e,
                        onLeafAction: o,
                        visible: !0,
                        treeId: n,
        ...
        B_ = (e, t, o) => zi(C_(e), A_(e, t), o.insetSoutheast(), Ui(), "southeast", Yi(e, {
            left: 1,
            bottom: 3
        }), O_),
        ...
        I_ = (e, t, o) => zi(C_(e), E_(e), o.insetNortheast(), Li(), "northeast", Yi(e, {
            left: 1,
            top: 2
        }), O_),
        ...
        z_ = (e, t, o) => zi(C_(e), M_(e, t), o.insetWest(), $i(), "west", Yi(e, {
            left: 1
        }), O_),
        H_ = e => {
            switch (e) {
    ...
    var hE = Object.freeze({
        ...
        bE = [vr("contextual", [sr("fadeInClass"), sr("fadeOutClass"), sr("transitionClass"), ir("lazyContext"), Di("onShow"), Di("onShown"), Di("onHide"), Di("onHidden")]), Cr("lazyViewport", (() => ({
            bounds: en(),
            optScrollEnv: A.none()
    ...
    const vE = Cl({
        ...
        TE = (e, t) => {
            const o = Ql(),
                ...
                s = t => {
                    e.inline || OE(t), _E(e, vE.isDocked(t)), t.getSystem().broadcastOn([Xd()], {}), n().each((e => e.getSystem().broadcastOn([Xd()], {})))
                },
    ...
    const AE = Dn([Yb, nr("items", Fn([Rn([Jb, dr("items", Hn)]), Hn]))].concat(_v)),
        ME = [pr("text"), pr("tooltip"), pr("icon"), xr("search", !1, Fn([Ln, Dn([pr("placeholder")])], (e => d(e) ? e ? A.some({
            placeholder: A.none()
        }) : A.none() : A.some(e)))), ir("fetch"), Cr("onSetup", (() => b))],
        DE = Dn([Yb, ...ME]),
    ...
    const JE = Cl({
            ...
            factory: (e, t, o, n) => {
                ...
                return {
                    ...
                    behaviours: hu(e.splitToolbarBehaviours, [ew.config({
                        others: {
                            overflowGroup: () => yA.sketch({ ...n["overflow-group"](),
                                items: [r.asSpec()]
                            })
                        }
                    })]),
        ...
        OA = x([Lu({
            ...
            name: "overflow",
            overrides: e => ({
                toolbarBehaviours: kl([TC.config({
                    dimension: {
                        property: "height"
                    },
        ...
        TA = hm({
            ...
            factory: (e, t, o, n) => {
                ...
                return {
                    ...
                    behaviours: hu(e.splitToolbarBehaviours, [ew.config({
                        others: {
                            overflowGroup: e => yA.sketch({ ...n["overflow-group"](),
                                items: [Ph.sketch({ ...n["overflow-button"](),
                                    action: t => {
                                        Fs(e, r)
                                    }
                                })]
        ...
        NA = {
            ...
            togglebutton: [...RA, Or("active", !1), ar("type", ["togglebutton"])]
        },
            ...
            factory: {
                sketch: e => ({
                    ...
                    components: [{
                        ...
                        components: [],
                        behaviours: kl([Jw.config({}), eh.config({}), TC.config({
                            dimension: {
                                property: "width"
                            },
                    ...
                    behaviours: kl([xO(0), Kp("sidebar-sliding-events", [Us(qE, ((e, t) => {
                    ...
                    BT.getPart(t, e, "sidebar").each((e => ((e, t) => {
                        ym.getCurrent(e).each((o => {
                            ym.getCurrent(o).each((n => {
                                TC.hasGrown(o) ? LE.isShowing(n, t) ? (TC.shrink(o), GE(e.element, "presentation")) : (LE.hideAllSlots(n), LE.showSlot(n, t), GE(e.element, "region")) : (LE.hideAllSlots(n), LE.showSlot(n, t), TC.grow(o), GE(e.element, "region"))
                            }))
                        }))
                    })(e, o)))
                },
    ...
    const CM = (e, t, o) => {
        ...
        EM = (e, t) => {
            const o = t(),
                n = H(o, (e => e.format));
            return A.from(e.formatter.closest(n)).bind((e => G(o, (t => t.format === e)))).orThunk((() => Oe(e.formatter.match("p"), {
                title: "Paragraph",
                format: "p"
            })))
        },
            ...
            const t = "System Font",
                o = () => {
                    const o = e => e ? DM(e)[0] : "",
                        ...
                        })).orThunk((() => Oe((e => 0 === e.indexOf("-apple-system") && (() => {
        ...
        RM = (e, t) => A.from(IM.exec(e)).bind((e => {
            const o = Number(e[1]),
                n = e[2];
            return ((e, t) => N(t, (t => N(FM[t], (t => e === t)))))(n, t) ? A.some({
                value: o,
                unit: n
            }) : A.none()
        })),
        ...
        ZM = (e, t, o, n, r) => {
            ...
            return {
                ...
                buttonBehaviours: kl([xy(r.isDisabled), by(), Kp(HO, [Ys(((e, t) => PO(e))), Us($O, ((e, t) => {
                    s.bind((t => t.getOpt(e))).each((e => {
        ...
        QM = (e, t, o) => {
            ...
            return Ph.sketch({
                ...
                components: s.components,
                eventOrder: LO,
                buttonBehaviours: { ...kl([Kp("toolbar-button-events", [(a = {
                        onAction: e.onAction,
                        getApi: t.getApi
                    }, Qs(((e, t) => {
                        wy(a, e)((t => {
        ...
        oD = (e, t, o) => n => sw((e => t.fetch(e))).map((r => A.from(Ew(fn(Px(la("menu-value"), r, (o => {
        ...
        sD = {
            ...
            splitbutton: rD((e => qn("SplitButton", FE, e)), ((e, t) => ((e, t) => {
                const o = e => ({
                        ...
                        setText: t => pi(e.element, "span").each((o => e.getSystem().getByDom(o).each((e => Is(e, $O, {
                            text: t
                        }))))),
                        setIcon: t => pi(e.element, "span").each((o => e.getSystem().getByDom(o).each((e => Is(e, qO, {
                            icon: t
                        })))))
                    }),
                    n = Er(b),
                ...
                return qM.sketch({
                    ...
                    components: [qM.parts.button(ZM(e.icon, e.text, A.none(), A.some([lh.config({
                        toggleClass: "tox-tbtn--enabled",
                        toggleOnExecute: !1
                    })]), t.providers)), qM.parts.arrow({
                        dom: {
                            tag: "button",
                    ...
                    f = Uh({
                        ...
                        components: [Fb.sketch({
                            inputBehaviours: kl([Kp(i, [Sy({
                                ...
                                getApi: s
                            }, a)]), Kp("input-update-display-text", [Us($O, ((e, t) => {
        ...
        iD = (e, t, o, n) => {
            const r = (e => {
                ...
                a = H(r, (r => {
                    const s = X(r.items, (r => 0 === r.trim().length ? [] : ((e, t, o, n, r, s) => be(t, o.toLowerCase()).orThunk((() => s.bind((e => se(e, (e => be(t, e + o.toLowerCase()))))))).fold((() => be(aD, o.toLowerCase()).map((t => t(e, r)))), (t => "grouptoolbarbutton" !== t.type || n ? ((e, t, o) => be(sD, e.type).fold((() => (console.error("skipping button defined by", e), A.none())), (n => A.some(n(e, t, o)))))(t, r, e) : (console.warn(`Ignoring the '${o}' toolbar button. Group toolbar buttons are only supported when using floating toolbar mode and cannot be nested.`), A.none()))))(e, t.buttons, r, t.allowToolbarGroups, o, n).toArray()));
                    return {
    ...
    const mD = e => /^[0-9\.]+(|px)$/i.test("" + e) ? A.some(parseInt("" + e, 10)) : A.none(),
        ...
        vD = (e, t, o, n, r) => {
            const {
                mainUi: s,
                uiMotherships: a
            } = o, i = nf.DOM, l = tb(e), c = rb(e), d = hf(e).or(hD(e)), u = n.shared.header, m = u.isPositionedAtTop, g = Sf(e), p = g === bD.sliding || g === bD.floating, h = Er(!1), f = () => h.get() && !e.removed, b = e => p ? e.fold(x(0), (e => e.components().length > 1 ? Wt(e.components()[1].element) : 0)) : 0, v = () => {
                L(a, (e => {
                    e.broadcastOn([Xd()], {})
                }))
            }, y = o => {
    ...
    var xD = Object.freeze({
        ...
        render: async (e, t, o, n, r) => {
            const {
                mainUi: s
            } = t, a = Ql(), i = Ve(r.targetNode), l = vD(e, i, t, n, a), c = Tf(e);
            await fM(e);
            const d = () => {
    ...
    const wD = "contexttoolbar-hide",
            ...
            const o = e.label.fold((() => ({})), (e => ({
                ...
                r = ((e, t, o) => {
                    ...
                    return {
                        ...
                        findPrimary: e => se(t, ((t, o) => t.primary ? A.from(n[o]).bind((t => t.getOpt(e))).filter(O(Fm.isDisabled)) : A.none()))
                    }
                })(n, e.commands, t);
            return [{
                title: A.none(),
        ...
        DD = (e, t, o, n) => {
            const r = t => (n, r, s, a, i) => ({ ...MD(e, a, t, o, i)({ ...n,
                        y: i.y,
                        height: i.height
                    }, r, s, a, i),
                    alwaysFit: !0
            ...
            const r = n.backstage,
                ...
                d = si((e => {
                    ...
                    return Hh.sketch({
                        ...
                        onShow: e => {
                            ...
                            })), Pa(e.element, VD), Ht(e.element, "width")
                        },
                        inlineBehaviours: kl([Kp("context-toolbar-events", [Ks(os(), ((e, t) => {
                            ...
                            ne(t.get()).each((o => {
                                t.set(t.get().slice(0, t.get().length - 1)), Is(e, ND, {
                                    contents: ai(o.bar),
                                    focus: o.focus
                                })
                            }))
                            ...
                            mode: "special",
                            onEscape: o => ne(t.get()).fold((() => e.onEscape()), (e => (Fs(o, RD), A.some(!0))))
                        })]),
                ...
                y = t => {
                    const {
                        ...
                        ...v().formNavigators
                    }, a = Sf(e) === tf.scrolling ? tf.scrolling : tf.default, i = q(H(t, (t => "contexttoolbar" === t.type ? ((t, o) => iD(e, {
                        buttons: t,
                        toolbar: o.items,
                        allowToolbarGroups: !1
                    }, n.backstage, A.some(["form:"])))(r, t) : ((e, t) => kD(e, t))(t, s.providers))));
                    return IA({
                        type: a,
                ...
                x = (t, n) => {
                    ...
                    c.set(p), l.set(1);
                    const b = d.element;
                    Ht(b, "display"), (e => xe(Se(e, i.get(), Ze), !0))(n) || (Pa(b, zD), xd.reset(o, d)), Hh.showWithinBounds(d, f(r), {
                        anchor: h,
                        transition: {
                            classes: [zD],
                            mode: "placement"
                    ...
                    return (e => !n(e) && !Qe(o, e))(r) ? A.none() : ((e, t, o) => {
                        ...
                        if (Ge(e)) {
                            const {
                                contextToolbars: t,
                                contextForms: n
                            } = BD(e, o.inNodeScope), r = n.length > 0 ? n : (e => {
                                if (e.length <= 1) return e; {
        ...
        PD = {
            ...
            icon: "line-height",
            getOptions: Kf,
            hash: e => ((e, t) => RM(e, ["fixed", "relative", "empty"]).map((({
                value: e,
                unit: t
            }) => e + t)))(e).getOr(e),
            display: w,
        ...
        $D = (e, t) => vM(e, "Undo Redo AddUndo TypingUndo ClearUndos SwitchMode", (o => {
            o.setEnabled(!e.mode.isReadOnly() && e.undoManager[t]())
        })),
        qD = e => vM(e, "VisualAid", (t => {
        ...
        oB = (e, t) => "contextmenu" === t.type || "longpress" === t.type ? e.inline ? (e => {
            if (tB(e)) {
                const t = e.touches[0];
                    ...
                    ((e, t, o, n, r, s, a) => {
                        ...
                        ZO(o, ub.CLOSE_ON_EXECUTE, n, {
                            ...
                            Hh.showMenuWithinBounds(r, {
                                ...
                                data: o,
                                type: "horizontal"
                            }, (() => A.some(_D(e, n.shared, "node" === s ? "node" : "selection")))), e.dispatch(wD)
                        }))
                    })(e, t, a, n, r, s, !(c || i || l && d))
                };
            if ((l || i) && "node" !== s) {
            ...
            switch (e.type) {
                ...
                default:
                    ...
                    return {
                        type: "menuitem",
                        ...t(o),
                        onAction: v(o.onAction)
                    }
            }
        },
        mB = (e, t) => {
            if (0 === t.length) return e;
            const o = ne(e).filter((e => !cB(e))).fold((() => []), (e => [dB]));
        ...
        hB = (e, t, o) => {
            const n = Do().deviceType.isTouch,
                r = si(Hh.sketch({
                    ...
                    fireDismissalEventInstead: {},
                    inlineBehaviours: kl([Kp("dismissContextMenu", [Us(Os(), ((t, o) => {
                        $d.close(t), e.focus()
                    }))])])
                })),
                a = () => Hh.hide(r),
        ...
        NB = e => {
            (e => {
                rt(e.element).filter(Ge).each((e => {
                    _t(e, IB).fold((() => Ht(e, "z-index")), (t => Dt(e, "z-index", t))), Et(e, IB)
                }))
            })(e), e.getSystem().removeFromGui(e)
        },
        VB = (e, t, o) => e.getSystem().build(jw.sketch({
            dom: {
                styles: {
                    left: "0px",
                    top: "0px",
    ...
    const HB = [yr("useFixed", T), or("blockerClass"), yr("getTarget", w), yr("onDrag", b), yr("repositionTarget", !0), yr("onDrop", b), Cr("getBounds", en), zB],
        LB = e => {
            return (t = Nt(e, "left"), o = Nt(e, "top"), n = Nt(e, "position"), t.isSome() && o.isSome() && n.isSome() ? A.some(((e, t, o) => ("fixed" === o ? TB : CB)(parseInt(e, 10), parseInt(t, 10)))(t.getOrDie(), o.getOrDie(), n.getOrDie())) : A.none()).getOrThunk((() => {
                const t = Xt(e);
                    ...
                    if (t.repositionTarget) {
                        const s = et(e.element),
                            ...
                            c = ((e, t, o, n, r, s, a) => ((e, t, o, n, r) => {
                                ...
                                const e = (t = o, a = s.left, i = s.top, t.fold(((e, t) => CB(e + a, t + i)), ((e, t) => _B(e + a, t + i)), ((e, t) => TB(e + a, t + i))));
                                var t, a, i;
                                const l = xB(e, n, r);
    ...
    const $B = (e, t, o) => [Us(Wr(), ((n, r) => {
            ...
            const s = () => WB(n, A.some(l), e, t),
                ...
                l = VB(n, e.blockerClass, (e => Hs([Us(Wr(), e.forceDrop), Us($r(), e.drop), Us(jr(), ((t, o) => {
                    e.move(o.event)
                })), Us(Gr(), e.delayDrop)]))(i));
            o(n), RB(n, l)
        }))],
    ...
    const KB = (e, t, o) => {
            ...
            return [Us(Hr(), ((s, a) => {
                ...
                const i = () => r(s),
                    ...
                    c = VB(s, e.blockerClass, (e => Hs([Us(Hr(), e.forceDrop), Us(Pr(), e.drop), Us(Ur(), e.drop), Us(Lr(), ((t, o) => {
                        e.move(o.event)
                    }))]))(l));
                n.set(c), o(s), RB(s, c)
            })), Us(Lr(), ((o, n) => {
        ...
        ZB = [...HB, Ri("dragger", {
            handlers: jB(((e, t, o) => [...$B(e, t, o), ...KB(e, t, o)]))
        })];
    ...
    const tF = Tl({
        ...
        oF = (e, t, o, n, r, s) => e.fold((() => tF.snap({
            sensor: _B(o - 20, n - 20),
            range: $t(r, s),
            output: _B(A.some(o), A.some(n)),
            extra: {
                td: t
            }
        })), (e => {
    ...
    const lF = (e, t, o) => {
            ...
            components: (() => {
                const o = (() => {
                    ...
                    n = ((e, t) => {
                        ...
                        return o === iF.None ? A.none() : A.some(Zh("resize-handle", {
                            tag: "div",
                            classes: ["tox-statusbar__resize-handle"],
                            attributes: {
                                title: t.translate("Resize")
                            },
                            behaviours: [tF.config({
                                mode: "mouse",
                                repositionTarget: !1,
                                onDrag: (t, n, r) => lF(e, r, o),
        ...
        mF = (e, t) => {
            ...
            return {
                popups: {
                    backstage: b.popup,
                    getMothership: () => uF("popups", l)
                },
                dialogs: {
                    backstage: b.dialog,
                    getMothership: () => uF("dialogs", i)
                },
                renderUI: () => {
                    const o = v(),
                        a = (() => {
                    ...
                    return (t => {
                        ...
                        })(e), eA(e, f, b.popup.shared), HD(e, c, s.sink, {
                            backstage: b.popup
                        }), sF(e, s.sink);
                        const x = {
        ...
        TI = Dn(_I),
        EI = _I.concat([dr("children", Zn(0, (() => jn("type", {
            directory: AI,
            leaf: TI
        }))))]),
        AI = Dn(EI),
        ...
        NI = e => Qn("items", "items", {
            tag: "required",
            process: {}
        }, Bn(Gn((t => qn(`Checking item of ${e}`, VI, t).fold((e => rn.error(Yn(e))), (e => rn.value(e))))))),
        VI = En((() => {
            return jn("type", {
                alertbanner: _F,
        ...
        WI = xF,
        jI = OF,
        GI = Dn([sr("title"), nr("body", jn("type", {
            panel: HI,
            tabpanel: UI
        })), Sr("size", "normal"), dr("buttons", jI), yr("initialData", {}), Cr("onAction", b), Cr("onChange", b), Cr("onSubmit", b), Cr("onClose", b), Cr("onCancel", b), Cr("onTabChange", b)]),
        ...
        sR = (e, t, o) => {
            ...
            return {
                ...
                behaviours: kl([Hp.config({
                    ...
                    postprocess: e => rR(e).fold((e => (console.error(e), {})), w)
                })])
            };
            var r
        },
        ...
        SR = (e, t, o) => {
                    ...
                    const t = Ql(),
                        o = [Ys((o => {
                            ...
                            yR(n).each((e => {
                                ...
                                r.forall((e => s > e)) ? (t.set(s), vR(n, e, t)) : r.each((t => {
                                    bR(e, t)
            ...
            return fR.sketch({
                ...
                tabSectionBehaviours: kl([Kp("tabpanel", l.extraEvents), Hp.config({
                    ...
                    find: e => oe(fR.getViewItems(e))
                }), _O(A.none(), (e => (e.getSystem().broadcastOn([xR], {}), n.get())), ((e, t) => {
    ...
    function FR(e) {
        return function(e) {
            ...
            if (e) {
                ...
                return "Object" === o && e.constructor && (o = e.constructor.name), "Map" === o || "Set" === o ? Array.from(e) : "Arguments" === o || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o) ? IR(e, t) : void 0
            }
        }(e) || function() {
    ...
    var iN = LR(["a", "abbr", "acronym", "address", "area", "article", "aside", "audio", "b", "bdi", "bdo", "big", "blink", "blockquote", "body", "br", "button", "canvas", "caption", "center", "cite", "code", "col", "colgroup", "content", "data", "datalist", "dd", "decorator", "del", "details", "dfn", "dialog", "dir", "div", "dl", "dt", "element", "em", "fieldset", "figcaption", "figure", "font", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup", "hr", "html", "i", "img", "input", "ins", "kbd", "label", "legend", "li", "main", "map", "mark", "marquee", "menu", "menuitem", "meter", "nav", "nobr", "ol", "optgroup", "option", "output", "p", "picture", "pre", "progress", "q", "rp", "rt", "ruby", "s", "samp", "section", "select", "shadow", "small", "source", "spacer", "span", "strike", "strong", "style", "sub", "summary", "sup", "table", "tbody", "td", "template", "textarea", "tfoot", "th", "thead", "time", "tr", "track", "tt", "u", "ul", "var", "video", "wbr"]),
        ...
        EN = function e() {
            ...
            var Ae = function(e) {
                ...
                Re = function(e) {
                    return "object" === AR(i) ? e instanceof i : e && "object" === AR(e) && "number" == typeof e.nodeType && "string" == typeof e.nodeName
                },
                Ne = function(e, t, n) {
                    M[e] && qR(M[e], (function(e) {
                        e.call(o, t, n, xe)
                    }))
                },
                Ve = function(e) {
                    ...
                    if (Ne("uponSanitizeElement", e, {
                            tagName: n,
                            allowedTags: L
                        }), e.hasChildNodes() && !Re(e.firstElementChild) && (!Re(e.content) || !Re(e.content.firstElementChild)) && tN(/<[/\w]/g, e.innerHTML) && tN(/<[/\w]/g, e.textContent)) return Me(e), !0;
                    ...
                    return e instanceof l && !Ae(e) ? (Me(e), !0) : "noscript" !== n && "noembed" !== n || !tN(/<\/no(script|embed)/i, e.innerHTML) ? (Y && 3 === e.nodeType && (t = e.textContent, t = ZR(t, F, " "), t = ZR(t, I, " "), e.textContent !== t && (KR(o.removed, {
                        element: e.cloneNode()
                ...
                ze = function(e, t, o) {
                    ...
                    if (X && !$[t] && tN(R, t));
                        ...
                        if (!(He(e) && (j.tagNameCheck instanceof RegExp && tN(j.tagNameCheck, e) || j.tagNameCheck instanceof Function && j.tagNameCheck(e)) && (j.attributeNameCheck instanceof RegExp && tN(j.attributeNameCheck, t) || j.attributeNameCheck instanceof Function && j.attributeNameCheck(t)) || "is" === t && j.allowCustomizedBuiltInElements && (j.tagNameCheck instanceof RegExp && tN(j.tagNameCheck, o) || j.tagNameCheck instanceof Function && j.tagNameCheck(o)))) return !1
                    } else if (ue[t]);
                    else if (tN(H, ZR(o, z, "")));
    ...
    const AN = e => EN().sanitize(e),
        ...
        BN = (e, t) => fF.parts.close(Ph.sketch({
            dom: {
                tag: "button",
        ...
        IN = (e, t) => fF.parts.body({
            ...
            components: [{
                ...
                components: [{
                    dom: ZE(`<p>${AN(t.translate(e))}</p>`)
                }]
            }]
        }),
        RN = e => fF.parts.footer({
            dom: {
                tag: "div",
        ...
        jN = (e, t, o, n) => si(VN({ ...e,
            ...
            extraBehaviours: [nR.config({
                channel: `${kR}-${e.id}`,
                updateState: (e, t) => A.some(t),
                initialData: t
            }), TO({}), ...e.extraBehaviours],
            onEscape: e => {
                Fs(e, sS)
            },
            dialogEvents: o,
        ...
        XN = (e, t, o) => {
            const n = (t, o) => Us(t, ((t, n) => {
                ...
                r = (e, t) => {
                    nR.getState(e).get().each((o => {
                        t(o.internalDialog, e)
                    }))
                };
            return [...qN(n, t), n(iS, ((e, t) => t.onSubmit(e))), n(nS, ((e, t, o) => {
                t.onChange(e, {
                    name: o.name
                })
            })), n(aS, ((e, t, n, r) => {
        ...
        ZN = (e, t) => {
            if (e.getRoot().getSystem().isConnected()) {
                ...
                return mO.getField(o, t).orThunk((() => {
                    const o = e.getFooter();
                    return nR.getState(o).get().bind((e => e.lookupByName(t)))
                }))
            }
            return A.none()
        },
            ...
            const n = t => {
                ...
                r = {
                    ...
                    setData: t => {
                        n((n => {
                            const s = r.getData(),
                                ...
                                i = ((e, t) => {
                                    const o = e.getRoot();
                                    return nR.getState(o).get().map((e => Xn(qn("data", e.dataValidator, t)))).getOr(t)
                                })(e, a),
                                l = e.getFormWrapper();
                    ...
                    showTab: t => {
                        n((o => {
                            const n = e.getBody();
                            nR.getState(n).get().exists((e => e.isTabPanel())) && ym.getCurrent(n).each((e => {
                                fR.showTab(e, t)
                            }))
                        }))
                    },
                    redial: s => {
                        n((n => {
                            ...
                            n.getSystem().broadcastOn([`${kR}-${a}`], i), n.getSystem().broadcastOn([`${OR}-${a}`], i.internalDialog), n.getSystem().broadcastOn([`${CR}-${a}`], i.internalDialog), n.getSystem().broadcastOn([`${_R}-${a}`], { ...i.internalDialog,
                                buttons: l
    ...
    const tV = ["insertContent", "setContent", "execCommand", "close", "block", "unblock"],
        ...
        nV = (e, t, o, n) => {
            const r = la("dialog"),
                ...
                c = e.buttons.bind((e => 0 === e.length ? A.none() : A.some(JN({
                    buttons: e
                }, r, n)))),
                u = ((e, t) => {
                ...
                h = new eV(e.url, {
                    base_uri: new eV(window.location.href)
                }),
                ...
                a = (n, r, s, a = !1) => QI.open(((n, i, l) => {
                    const c = Xn(qn("data", l, i)),
                        ...
                        g = ((e, t, o, n) => {
                            const r = la("dialog"),
                                ...
                                l = Uh(((e, t, o, n) => jw.sketch({
                                    ...
                                    containerBehaviours: kl([tF.config({
                                        mode: "mouse",
                                        blockerClass: "blocker",
                                ...
                                c = Uh(((e, t, o, n, r) => ER(e, t, A.some(o), n, r))({
                                    body: i.body,
                        ...
                        p = si(Hh.sketch({
                            ...
                            inlineBehaviours: kl([Kp("window-manager-inline-events", [Us(Os(), ((e, t) => {
                                Fs(g.dialog, sS)
                            }))]), ...rV(t, o, u)]),
