...
! function() {
    ...
    const ne = e => b(e, R),
        ...
        se = (e, t) => {
            ...
            oe(t, ((e, t) => {
                ((e, t, n) => {
                    if (!(r(n) || i(n) || d(n))) throw console.error("Invalid call to Attribute.set. Key ", t, ":: Value ", n, ":: Element ", e), new Error("Attribute value was not simple");
                    e.setAttribute(t, n + "")
                })(n, t, e)
            }))
        },
    ...
    const ue = e => t => l(t) && t.nodeName.toLowerCase() === e,
        ...
        Ee = (e, t) => {
            ...
            for (a = n.create(s, i), Le(t.firstChild, r) || o.appendChild(a); l = t.firstChild;) {
                const e = l.nodeName;
                d || "SPAN" === e && "bookmark" === l.getAttribute("data-mce-type") || (d = !0), Le(l, r) ? (o.appendChild(l), a = null) : (a || (a = n.create(s, i), o.appendChild(a)), a.appendChild(l))
            }
        ...
        Me = (e, t) => {
            var n;
            Ie(t) ? ae(t, "dt") : Pe(t) && (n = t, g.from(n.dom.parentElement).map(R)).each((n => ((e, t, n) => {
    ...
    const tt = (e, t, n) => {
        ...
        mt = (e, t) => {
            ...
            return ((e, t) => {
                const n = L(t, ((t, n) => n.depth > t.length ? ((e, t, n) => {
                    ...
                    })(r, n), o = r, I(D(t), w(o), nt), t.concat(r)
                })(e, t, n) : ((e, t, n) => {
        ...
        gt = (e, t) => {
            ...
            if (n.length || r.length) {
                ...
                })(e, t, r), e.selection.moveToBookmark(s), e.selection.setRng($e(e.selection.getRng())), e.nodeChanged(), o = !0
            }
            return o
        },
        ht = (e, t) => !(e => {
    ...
    const St = de.DOM,
            ...
            const t = {},
                n = n => {
                    ...
                    if (ge(r)) {
                        ...
                        r.hasChildNodes() ? (o = Math.min(o, r.childNodes.length - 1), n ? r.insertBefore(e, r.childNodes[o]) : St.insertAfter(e, r.childNodes[o])) : r.appendChild(e), r = e, o = 0
                    }
                ...
                if (n) {
                    if (ge(n) && n.parentNode) {
                        ...
                        r = (e => {
                            ...
                            return -1
                        })(n), n = n.parentNode, St.remove(e), !n.hasChildNodes() && St.isBlock(n) && n.appendChild(St.create("br"))
                    }
        ...
        Tt = (e, t, n) => {
            ((e, t, n) => {
                ...
                kt(t, n["list-attributes"]), ce.each(e.select("li", t), (e => {
        ...
        xt = (e, t, n, r) => {
            ...
            if (n && pe(o))
                if (Ct(o.textContent)) o = i(o, !1).getOr(o);
                    ...
                    for (null !== o.parentNode && At(e, o.parentNode) && (o = o.parentNode); null !== o.previousSibling && (At(e, o.previousSibling) || pe(o.previousSibling));) o = o.previousSibling;
            if (!n && pe(o))
                if (Ct(o.textContent)) o = i(o, !0).getOr(o);
                else
                    for (null !== o.parentNode && At(e, o.parentNode) && (o = o.parentNode); null !== o.nextSibling && (At(e, o.nextSibling) || pe(o.nextSibling));) o = o.nextSibling;
            for (; o.parentNode !== r;) {
            ...
            const l = Nt(r),
                a = ((e, t, n) => {
                    ...
                    return ce.each(a, (t => {
                        ...
                        bt.isBookmarkNode(t) && (he(i) || Ne(e, i) || !i && t.parentNode === n) ? l = null : (l || (l = o.create("p"), null === (s = t.parentNode) || void 0 === s || s.insertBefore(l, t), r.push(l)), l.appendChild(t))
                    })), r
                })(e, r, s);
            ce.each(a, (r => {
                let s;
                ...
                })(i, l, n) ? (s = l, r = i.rename(r, o), l.appendChild(r)) : (s = i.create(t), a.insertBefore(s, r), s.appendChild(r), r = i.rename(r, o)), ((e, t, n) => {
                ...
                })(i, r), Tt(i, s, n), Et(e.dom, s))
            })), e.selection.setRng(Lt(l))
        },
        Dt = (e, t, n) => {
            return ((e, t) => he(e) && e.nodeName === (null == t ? void 0 : t.nodeName))(t, n) && ((e, t, n) => e.getStyle(t, "list-style-type", !0) === e.getStyle(n, "list-style-type", !0))(e, t, n) && (r = n, t.className === r.className);
            var r
        },
        Et = (e, t) => {
        ...
        $t = (e, t, n) => {
            ...
            const s = n.lastChild;
            s && Se(s) && t.hasChildNodes() && e.remove(s), ke(e, n, !0) && J(R(n)), ((e, t, n) => {
                let r;
        ...
        _t = (e, t) => {
            ...
            if (i) {
                ...
                if (a && a !== i) return e.undoManager.transact((() => {
                    var n, r;
                    t ? ((e, t, n, r) => {
                        const o = e.dom;
                        if (o.isEmpty(r))((e, t, n) => {
                ...
                if (!a && !t && 0 === l.startOffset && 0 === l.endOffset) return e.undoManager.transact((() => {
                    vt(e)
                })), !0
            }
            return !1
                ...
                if (s && n.isEmpty(s)) {
                    ...
                    if (i) {
                        ...
                        return !!((e, t, n = u) => I(e, t, n).getOr(e.isNone() && t.isNone()))(q(R(i), l, a), q(R(r.startContainer), l, a), U) && (e.undoManager.transact((() => {
                            ...
                            })(n, s, o), Et(n, i.parentNode), e.selection.select(i, !0), e.selection.collapse(t)
                        })), !0)
                    }
                }
                return !1
    ...
    e.add("lists", (e => ((e => {
        ...
        e.on("BeforeExecCommand", (t => {
            ...
            vt(e)
        })), Qt(e), e.addCommand("mceListUpdate", ((t, n) => {
            o(n) && ((e, t) => {
                const n = He(e);
