...
! function() {
        ...
        T = (e, t) => {
            ...
            for (let a = A({
                ...
                if (1 === a.type) {
                    ...
                    r.source || "param" !== e || (r.source = a.attr("movie")), "iframe" !== e && "object" !== e && "embed" !== e && "video" !== e && "audio" !== e || (r.type || (r.type = e), r = k.extend(a.attributes.map, r)), "script" === e && (r = {
                        type: "script",
                        source: a.attr("src")
                    }), "source" === e && (r.source ? r.altsource || (r.altsource = a.attr("src")) : r.source = a.attr("src")), "img" !== e || r.poster || (r.poster = a.attr("src"))
                }
    ...
    const F = (e, t = {}) => A({
        ...
        B = (e, t) => {
            ...
            a.altsource || (a.altsource = ""), a.poster || (a.poster = ""), a.source = e.convertURL(a.source, "source"), a.altsource = e.convertURL(a.altsource, "source"), a.sourcemime = z(a.source), a.altsourcemime = z(a.altsource), a.poster = e.convertURL(a.poster, "poster");
            const o = (e => {
            ...
            if (o && (a.source = o.url, a.type = o.type, a.allowfullscreen = o.allowFullscreen, a.width = a.width || String(o.w), a.height = a.height || String(o.h)), a.embed) return E(a.embed, a, !0, e.schema); {
                const t = g(e),
                    r = b(e),
                    o = w(e);
                return a.width = a.width || "300", a.height = a.height || "150", k.each(a, ((t, r) => {
                    a[r] = e.dom.encode("" + t)
                })), "iframe" === a.type ? ((e, t) => {
                    if (t) return t(e); {
        ...
        H = (e, t) => {
            ...
            return r ? ((e, t, r) => new Promise(((a, o) => {
                const s = r => (r.html && (W[e.source] = r), a({
                    url: e.source,
            ...
            const m = {
                ...
                u = e.windowManager.open({
                    ...
                    onSubmit: t => {
                        ...
                        ((e, t, r) => {
                            var a, o;
                            t.embed = E(null !== (a = t.embed) && void 0 !== a ? a : "", t, !1, r.schema), t.embed && (e.source === t.source || (o = t.source, h(W, o))) ? Y(r, t.embed) : H(r, t).then((e => {
                                Y(r, e.html)
                            })).catch(V(r))
                        })(r.get(), a, e), t.close()
                    },
    ...
    const te = e => {
        ...
        ie = (e, t, r) => {
            ...
            for (; s--;) {
                const t = o[s].name;
                let a = o[s].value;
                "width" === t || "height" === t || "style" === t || (n = "data-mce-", (i = t).length >= n.length && i.substr(0, 0 + n.length) === n) || ("data" !== t && "src" !== t || (a = e.convertURL(a, t)), r.attr("data-mce-p-" + t, a))
            }
            var i, n;
            const l = M({
                    inner: !0
    ...
    e.add("media", (e => ((e => {
        ...
        e.on("PreInit", (() => {
            ...
            })(e)), r.addAttributeFilter("data-mce-object", ((t, r) => {
                var a;
                let o = t.length;
                for (; o--;) {
                    const s = t[o];
        ...
        e.on("click keyup touchend", (() => {
            ...
            if (r.getAttribute("data-mce-object")) {
                ...
                a && (a = unescape(a), r.setAttribute("data-mce-html", escape(E(a, {
