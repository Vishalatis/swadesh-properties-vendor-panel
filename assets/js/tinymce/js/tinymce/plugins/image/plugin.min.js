...
! function() {
    ...
    const U = e => e.length > 0,
        ...
        le = (e, t) => {
            ...
            return J(i, "style", t.style), ($(i) || "" !== t.hspace) && ee(i, t.hspace), (V(i) || "" !== t.vspace) && te(i, t.vspace), (K(i) || "" !== t.border) && ae(i, t.border), (se(i) || "" !== t.borderStyle) && ie(i, t.borderStyle), e(null !== (a = i.getAttribute("style")) && void 0 !== a ? a : "")
        },
        ce = (e, t) => ({
            src: Z(t, "src"),
            alt: ne(t),
        ...
        ue = (e, t, a) => {
            const i = ce(e, a);
            me(a, i, t, "caption", ((e, t, a) => (e => {
                q(e) ? (e => {
                    const t = e.parentNode;
                    d(t) && (W.insertAfter(e, t), W.remove(t))
                })(e) : (e => {
                    const t = W.create("figure", {
                        class: "image"
                    });
            ...
            })(e))), me(a, i, t, "src", J), me(a, i, t, "title", J), me(a, i, t, "width", X(0, e)), me(a, i, t, "height", X(0, e)), me(a, i, t, "class", J), me(a, i, t, "style", ge(((e, t) => J(e, "style", t)), e)), me(a, i, t, "hspace", ge(ee, e)), me(a, i, t, "vspace", ge(te, e)), me(a, i, t, "border", ge(ae, e)), me(a, i, t, "borderStyle", ge(ie, e)), ((e, t, a) => {
        ...
        be = (e, t) => {
            ...
            const i = e.dom,
                s = ((t, a) => {
                    ...
                    })(t, ((t, a) => !e.schema.isValidChild(a, "figure")), (s = i, (e, t) => {
                        s[t] = e
                    }), p), i
                })(e.schema.getTextBlockElements()),
                r = i.getParent(t.parentNode, (e => {
        ...
        ve = (e, t) => {
            const a = ((t, a) => {
                ...
                if (ue((t => pe(e, t)), { ...a,
                    ...
                    const e = W.create("figure", {
                        class: "image"
                    });
                    return e.appendChild(i), e.appendChild(W.create("figcaption", {
                        contentEditable: "true"
    ...
    var we, Ae = tinymce.util.Tools.resolve("tinymce.util.ImageUploader"),
    ...
    const _e = e => r(e.value) ? e.value : "",
        ...
        Te = e => {
            ...
            return w([
                ...
                [{ ...(s = e.classList.isSome() && e.hasImageCaption, s ? {
                        type: "grid",
                        columns: 2
                    } : {
                        type: "panel"
        ...
        Me = (e, t, a, i) => {
            ((e, t) => {
                ...
                if (void 0 !== i) {
                    const s = fe({}, a);
                    ((e, t, a) => {
                        e.hasDescription && r(a.alt) && (t.alt = a.alt), e.hasAccessibilityOptions && (t.isDecorative = a.isDecorative || t.isDecorative || !1), e.hasImageTitle && r(a.title) && (t.title = a.title), e.hasDimensions && (r(a.width) && (t.dimensions.width = a.width), r(a.height) && (t.dimensions.height = a.height)), r(a.class) && Se(e.classList, a.class).each((e => {
                            t.classes = e.value
                ...
                const s = i.getData(),
                    r = s.src.value,
                    o = s.src.meta || {};
                o.width || o.height || !t.hasDimensions || (U(r) ? e.imageSize(r).then((e => {
                    a.open && i.setData({
                        dimensions: e
                    })
                })).catch((e => console.error(e))) : i.setData({
                    dimensions: {
                        width: "",
                        height: ""
                    }
        ...
        Re = (e, t, a, i) => {
            const s = i.getData();
            var r;
            i.block("Uploading image"), (r = s.fileinput, ((e, t) => 0 < e.length ? h.some(e[0]) : h.none())(r)).fold((() => {
                i.unblock()
            }), (s => {
        ...
        ke = (e, t, a) => (i, s) => {
            "src" === s.name ? Me(e, t, a, i) : "images" === s.name ? ((e, t, a, i) => {
                const s = i.getData(),
        ...
        Pe = e => e.hasAdvTab || e.hasUploadUrl || e.hasUploadHandler ? {
            type: "tabpanel",
            tabs: w([
                [Oe(e)], e.hasAdvTab ? [{
                    title: "Advanced",
    ...
    e.add("image", (e => {
        (e => {
            ...
            e.addCommand("mceImage", qe(e).open), e.addCommand("mceUpdateImage", ((t, a) => {
