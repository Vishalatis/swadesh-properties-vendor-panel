...
! function() {
    ...
    const Me = e => e.length > 0,
        ...
        Je = e => {
            const t = {},
                o = [];
            var l;
            const n = (l = e, L(l, 0)).map((e => e.element)).bind(ze).bind(Ge).getOr({});
            let r = 0,
                a = 0,
                s = 0;
            const {
            ...
            P(i, (e => {
                ...
                P(e.cells, (e => {
                    ...
                    l.push(c)
                })), r++, o.push(Ve(e.element, l, e.section)), s++
            }));
            const {
                columns: m,
                colgroups: d
    ...
    const st = M(5, (e => {
        ...
        Dt = e => {
            ...
            return t.isSet("table_default_styles") ? o : ((e, t) => _t(e) || !St(e) ? t : Ot(e) ? { ...t,
                width: mt(e)
            } : { ...t,
                width: it
            })(e, o)
        ...
        It = e => {
            ...
            return t.isSet("table_default_attributes") ? o : ((e, t) => _t(e) || St(e) ? t : Ot(e) ? { ...t,
                width: mt(e)
            } : { ...t,
                width: it
            })(e, o)
    ...
    const jt = (e, t, o, l) => {
        ...
        zt = {
            ...
            styles: d({
                ...
                remove: (e, t) => {
                    ...
                    })(e.dom, t), Re(xe(e, "style").map(De), "") && Ae(e, "style")
                }
            }),
            attrs: d({
                get: Te,
                ...
                copyTo: (e, t) => {
                    ...
                    })(t, B(e.dom.attributes, ((e, t) => (e[t.name] = t.value, e)), {}))
                }
            }),
            insert: d({
                before: kt,
        ...
        uo = (e, t, o) => l => {
            const n = (e => {
                ...
                a = () => {
                    ...
                    r ? (l.setActive(!I(a, s)), n.set(e.formatter.formatChanged(t, (e => l.setActive(!e)), !0))) : (l.setActive(q(a, s)), n.set(e.formatter.formatChanged(t, l.setActive, !1, {
                        value: o
                    })))
                };
        ...
        wo = (e, t, o) => {
            const l = N(t, (e => {
                return {
                    text: e.title,
                    value: "#" + (o = e.value, (t = o, (e => eo.test(e) || to.test(e))(t) ? y.some({
                        value: oo(t)
        ...
        Io = (e, t, o) => {
            const l = (e => {
                ...
                return (l = t, ((e, t, o = h) => o(t) ? y.none() : D(e, G(t)) ? y.some(t) : me(t, e.join(","), (e => z(e, "table") || o(e))))(["td", "th"], l, n)).bind((t => Do(e, t))).filter(o);
                var l, n
            })));
                        ...
                        (a || A(n, "scope")) && ((e, t, o, l) => {
                            ...
                            P(t, (t => {
                                const r = t.element,
                                    ...
                                    s = Ao(e, r);
                                ((e, t, o, l) => {
                                    l("scope") && e.setAttrib("scope", o.scope), l("class") && e.setAttrib("class", o.class), l("height") && e.setStyle("height", fe(o.height)), l("width") && t.setStyle("width", fe(o.width))
                                })(s, t.column.map((t => Ao(e, t))).getOr(s), o, a), gt(e) && ((e, t, o) => {
                                    o("backgroundcolor") && e.setFormat("tablecellbackgroundcolor", t.backgroundcolor), o("bordercolor") && e.setFormat("tablecellbordercolor", t.bordercolor), o("borderstyle") && e.setFormat("tablecellborderstyle", t.borderstyle), o("borderwidth") && e.setFormat("tablecellborderwidth", fe(t.borderwidth))
                                })(s, o, a), l("halign") && ot(e, r, o.halign), l("valign") && ((e, t, o) => {
            ...
            l.close(), e.undoManager.transact((() => {
                ((e, t, o, l) => {
                    ...
                    if (T(n) > 0) {
                        ...
                        })(e, l), ze(V.fromDom(t[0])).each((t => lt(e, t.dom, {
                            structure: o,
                            style: r
                        })))
                    }
        ...
        Xo = (e, t, o, n) => {
            if ("TD" === t.tagName || "TH" === t.tagName) l(o) && s(n) ? e.setStyle(t, o, n) : e.setStyles(t, o);
                ...
                for (let l = 0; l < t.children.length; l++) Xo(e, t.children[l], o, n)
        },
        Yo = (e, t, o, l) => {
            const n = e.dom,
                r = l.getData(),
                s = v(r, ((e, t) => o[t] !== e));
            l.close(), "" === r.class && delete r.class, e.undoManager.transact((() => {
                if (!t) {
                ...
                if (T(s) > 0) {
                    ((e, t, o) => {
                        const l = e.dom,
                            n = {},
                            r = {};
                        if (a(o.class) || (n.class = o.class), r.height = fe(o.height), St(e) ? r.width = fe(o.width) : l.getAttrib(t, "width") && (n.width = (e => e ? e.replace(/px$/, "") : "")(o.width)), St(e) ? (r["border-width"] = fe(o.border), r["border-spacing"] = fe(o.cellspacing)) : (n.border = o.border, n.cellpadding = o.cellpadding, n.cellspacing = o.cellspacing), St(e) && t.children)
                            for (let n = 0; n < t.children.length; n++) Xo(l, t.children[n], {
        ...
        Zo = (e, t) => {
            ...
            t ? (n.cols = "1", n.rows = "1", ft(e) && (n.borderstyle = "", n.bordercolor = "", n.backgroundcolor = "")) : (l = o.getParent(e.selection.getStart(), "table", e.getBody()), l ? n = ((e, t, o) => {
                const l = e.dom,
            ...
            })(e, l, ft(e)) : ft(e) && (n.borderstyle = "", n.bordercolor = "", n.backgroundcolor = ""));
            const r = bo(Tt(e));
        ...
        ll = (e, t, o) => {
            return t.length <= 1 ? y.none() : (l = e, n = o.firstSelectedSelector, r = o.lastSelectedSelector, $t(l, n, r).bind((e => {
                const t = e => $(l, e),
        ...
        nl = e => {
            ...
            const n = ee("caption"),
                ...
                c = () => {
                    ...
                    })(a)()), l = t.get().bind(s), P(o.get(), g)
                },
                i = e => (e(), o.set(o.get().concat([e])), () => {
                    o.set(k(o.get(), (t => t !== e)))
                }),
                m = (e, o) => i((() => t.get().fold((() => {
                    e.setEnabled(!1)
    ...
    e.add("table", (e => {
        ...
        (e => {
            ...
            const o = t => () => e.execCommand(t),
                l = (t, l) => !!e.queryCommandSupported(l.command) && (e.ui.registry.addMenuItem(t, { ...l,
                    onAction: c(l.onAction) ? l.onAction : o(l.command)
                }), !0),
                n = (t, l) => {
                    e.queryCommandSupported(l.command) && e.ui.registry.addToggleMenuItem(t, { ...l,
                        onAction: c(l.onAction) ? l.onAction : o(l.command)
                    })
                },
                r = t => {
            ...
            const o = t => () => e.execCommand(t),
                l = (t, l) => {
                    e.queryCommandSupported(l.command) && e.ui.registry.addButton(t, { ...l,
                        onAction: c(l.onAction) ? l.onAction : o(l.command)
                    })
                },
                n = (t, l) => {
                    e.queryCommandSupported(l.command) && e.ui.registry.addToggleButton(t, { ...l,
                        onAction: c(l.onAction) ? l.onAction : o(l.command)
                    })
                };
            l("tableprops", {
